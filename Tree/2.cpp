...
Tree<int>* takeInputLevelWise(){
	...
	while(pendingNodes.size()!=0){
		...
		for(int i=0;i<numChild;i++){
			cout<<"Enter the data of "<<i+1<<"th child of node "<<front->data <<endl;
			int childData;
			cin>>childData;
...
int main()
{
	...
	//  Tree<int>* root2 = takeInputLevelWise();
	...
	// int data;
	// cin>>data;
	// cout<<gretarThan(root,data);
	// cout<<sumOfNode(root)->data<<endl;
	
	// if(indenticalTree(root,root2)==1){
	// 	cout<<"true"<<endl;
	// }else{
	// 	cout<<"false"<<endl;
	// }
	...
	// int data;
	// cin>>data;
	// cout<<justGreaterThan(root,data)->data<<endl;
	cout<<secondLargestValue(root)<<endl;
	delete root;
	// delete root2;
return 0;
}
